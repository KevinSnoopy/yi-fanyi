/* ========================================================================
   译语 v5 · 全流程演示原型 · 行为层
   - 所有数据 mock，无真实网络/ASR
   - 每个流程通过 render() 渲染到 #stageOverlay
...
(() => {
  ...
  function renderA() {
    ...
    setDemoControls(STATES, runA, resetA);
    ...
    function barAt(stateIdx) {
      ...
      if (stateIdx === 0) {
        ...
        playTimer = setTimeout(() => {
          ...
          playTimer = setTimeout(() => bar.remove(), 250);
        }, 1500);
      }
    ...
    function autoPlay() {
      ...
      barAt(0);
      playTimer = setTimeout(() => barAt(1), 1800);
      playTimer = setTimeout(() => barAt(2), 3400);
      playTimer = setTimeout(() => barAt(3), 5400);
    }
  ...
  function renderB() {
    ...
    function runB() {
      miniAt(0);
      playTimer = setTimeout(() => miniAt(1), 600);
      playTimer = setTimeout(() => miniAt(2), 1500);
      playTimer = setTimeout(() => miniAt(3), 3500);
    }
  ...
  function renderC() {
    ...
    function runC() {
      cAt(0);
      playTimer = setTimeout(() => cAt(1), 700);
      playTimer = setTimeout(() => cAt(2), 1700);
      playTimer = setTimeout(() => cAt(3), 3000);
    }
  ...
  function renderD() {
    ...
    function runD() {
      dAt(0);
      playTimer = setTimeout(() => dAt(1), 1400);
      playTimer = setTimeout(() => dAt(2), 2700);
    }
  ...
  function renderE() {
    ...
    function runE() {
      eAt(0);
      playTimer = setTimeout(() => eAt(1), 1200);
      playTimer = setTimeout(() => eAt(2), 2700);
    }
  ...
  function renderF() {
    ...
    function fAt(stateIdx) {
      ...
      if (stateIdx === 0) {
        ...
        playTimer = setTimeout(() => {
          ...
          playTimer = setTimeout(() => banner.remove(), 250);
        }, 2200);
      }
    ...
    function runF() {
      fAt(0);
      playTimer = setTimeout(() => fAt(1), 1500);
      playTimer = setTimeout(() => fAt(2), 3300);
      playTimer = setTimeout(() => fAt(3), 6000);
    }
  ...
  function renderG() {
    ...
    function runG() {
      gAt(0);
      playTimer = setTimeout(() => gAt(1), 1500);
      playTimer = setTimeout(() => gAt(2), 3000);
      playTimer = setTimeout(() => gAt(3), 4500);
      playTimer = setTimeout(() => gAt(4), 6000);
    }
  ...
  // 全局键盘快捷键（演示用）
  // ============================================================
  const HOTKEY_MAP = { "1": "A", "2": "B", "3": "C", "4": "D", "5": "E", "6": "F", "7": "G" };
  document.addEventListener("keydown", (e) => {
