...
> **现行版本：`v6-spa/`（13 页全量，2026-09-26，对应任务 T-017）**
> 覆盖 PRD §6 全部 13 项页面需求 + Popover 最近译文（§6 #13 / ADR-005）。
> 打开方式：浏览器直接打开 `v6-spa/index.html`，右下角「❓ 走查」有 13 页演示路径。

## 版本演进

| 版本 | 状态 | 页数 | 说明 |
|---|---|---|---|
| **v6-spa** | ✅ **现行** | 13 页 | 单文件 SPA（IIFE + render 分发），13 Tab 全量 + 整页模式 + 左侧导航 + 走查面板；Token 对齐 PRD §5.2（主色 #4F7CFF） |
...
|---|---|---|---|---|
| A | 语音输入 | P0 | §2.1 / §6 #1 | 录音中 → 翻译中 → 预览（1.2s 可改）→ 已落框 |
...
| K | 偏好/术语/Skills | P0 | §6 #9 | 三个子页：翻译偏好（风格 P1）/ 术语表（P0）/ Skills 模板（P1） |
...
prototypes/
├── README.md            本文件
├── v6-spa/              ✅ 现行 · 13 页全量（index.html / styles.css / app.js）
├── v5-spa/              🗄 留档 · 7 页（A–G）
...
- 用户走查 v6（重点：录音条形态 A/B/C 未拍板项 T-015 不在 v6 范围内，Tab A 维持现行单条形态）
