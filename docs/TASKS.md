...
| T-005 | 拍板 next_steps 三选项 | ⛔ 需用户 | — | 在 `next_steps.md` 写入决策日期与选项 | [`next_steps.md`](../next_steps.md) |
...
| ID | 任务 | 状态 | 依赖 | 验收要点 | 关联 |
|---|---|---|---|---|---|
| T-010 | 录音条三态 + 悬浮窗交互原型（选项 ①） | ⬜ | T-005 选 ① | 可运行 widget，覆盖 PRD §5.3 ①②的三态/四态 | PRD §5.3 |
...
| T-013 | Design Token 落地（浅/深主题 + 组件规格） | ⬜ | T-010 | Token 表与 PRD §5.2 一致，组件覆盖 ①–⑥ | PRD §5 |
